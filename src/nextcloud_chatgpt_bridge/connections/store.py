...
class ConnectionStore(Protocol):
    ...
    def get_pending(self, flow_id: str) -> PendingLoginRecord | None: ...

    def delete_pending(self, flow_id: str) -> None: ...

    def put_connection(self, record: ConnectionRecord) -> None: ...

    def get_connection(self, connection_id: str) -> ConnectionRecord | None: ...

    def list_connections(self) -> Iterable[ConnectionRecord]: ...
...
class InMemoryConnectionStore:
    ...
    def __init__(self) -> None:
        self._pending: dict[str, PendingLoginRecord] = {}
        self._connections: dict[str, ConnectionRecord] = {}

    def put_pending(self, record: PendingLoginRecord) -> None:
        self._pending[record.flow_id] = record
    ...
    def put_connection(self, record: ConnectionRecord) -> None:
        self._connections[record.connection_id] = record
